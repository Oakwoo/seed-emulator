...
def run(dumpfile = None):
    ...
    gpuhost.importFile(hostpath = os.path.dirname(os.path.realpath(__file__)) + "/CNN.py", containerpath = "/CNN.py").importFile(hostpath = os.path.dirname(os.path.realpath(__file__)) + "/GPUTest_Time.py", containerpath = "/GPUTest_Time.py")
