...
def train(
    ...
    limited_time: int
        Parameter for the maxmium time the model can train.
    Returns
    -------
    bool
        Whether the model have not completed the whole epochs of train within limited time.
    """
    ...
    for _ in range(epochs):
        if time.time() - start_time > limited_time: 
            print("Train time out! Terminate the training")
            return True
